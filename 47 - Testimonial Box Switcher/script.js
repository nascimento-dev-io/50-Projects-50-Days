...
const testimonialText = document.querySelector(".feedback");
const userImage = document.querySelector(".perfil-user img");
const userName = document.querySelector(".perfil-user .user-name");
const userOffice = document.querySelector(".perfil-user .user-office");
...
function changeTestimonials(index) {
  ...
  userOffice.textContent = testimonials[index].position;
}
